...
TThread* thr;
SvRTSPWidget* rtsp;
QMap<int, SvRTSPWidget*>rtspMap;
QMap<int, QWidget*> wdgMap;
...
QRectF Rls::boundingRect() const
{
    return QRectF(0, 0, 35, 35);
}

QPainterPath Rls::shape() const
{
    QPainterPath path;
...
void Rls::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(widget);
    ...
    QRectF rectangle(14.0, 15.0, 20.0, 20.0);
...
void Rls::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
    QGraphicsItem::mousePressEvent(event);
    update();
}

void Rls::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void Rls::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    QGraphicsItem::mouseReleaseEvent(event);
    update();
}

void Rls::mouseDoubleClickEvent(QGraphicsSceneMouseEvent *event)
{
  
/******************************************************************/  
  
  QMessageBox::information(0, "Info", "RLS visualization function", QMessageBox::Ok);
